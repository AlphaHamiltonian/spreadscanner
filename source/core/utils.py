...
import source.scanners.price_movement_detector as pmd
from source.scanners.spread_calculator import SpreadCalculator
...
class DataStore:
    ...
    def calculate_all_spreads(self):
        self.spread_calculator.calculate_all_spreads()

    def _calculate_spread(self, price1, price2, exchange1=None, symbol1=None, exchange2=None, symbol2=None):
        return self.spread_calculator._calculate_spread(price1, price2, exchange1, symbol1, exchange2, symbol2)
