...
class Config:
    ...
    MOVEMENT_THRESHOLD_PCT = 10  # Detect 10% moves
    MOVEMENT_TIME_WINDOW = 2.0     # Within 2 seconds
    MOVEMENT_ALERT_COOLDOWN = 86400   # 60 seconds between alerts per symbol    
    # Runtime flags
